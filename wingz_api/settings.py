...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rides.authentication.CustomTokenAuthentication',
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Wingz API',
    'DESCRIPTION': 'Ride-sharing API for managing users, rides, and events',
    'VERSION': '1.0.0',
    ...
    'TAGS': [
        ...
        {'name': 'Rides', 'description': 'Ride management and tracking'},
        {'name': 'Ride Events', 'description': 'Ride event logging'},
    ],
